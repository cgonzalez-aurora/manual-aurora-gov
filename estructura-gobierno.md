...
![Botón Gobernar de AuroraGov](./images/btn-gobernar.png)

Al presionar **Gobernar**, se despliega el formulario principal de creación de propuestas:

![Formulario Gobernar de AuroraGov](./images/formulario-gobernar.png)
...
<details markdown="1">
<summary><b>📘 ¿Cómo crear una unidad organizacional?</b></summary>
...
<details markdown="1">
<summary><b>📘 ¿Cómo crear un rol?</b></summary>

1. Selecciona la **Unidad de Origen** y la **Unidad Destino**.
2. En el campo **Acción**, selecciona **Crear rol** y haz clic en **Siguiente →**.

![Formulario Selección de Acción - Crear Rol](./images/formulario-gobernar-crear-rol.png)
...
![Formulario Detalles del Rol](./images/formulario-gobernar-crear-rol2.png)

4. Haz clic en **Siguiente →** e ingresa el **Título propuesta** y la **Descripción propuesta**. Luego, haz clic en **Revisar**.

![Formulario Datos de la Propuesta de Rol](./images/formulario-gobernar-crear-rol3.png)
...
![Resumen de la Propuesta de Crear Rol](./images/formulario-gobernar-crear-rol4.png)
